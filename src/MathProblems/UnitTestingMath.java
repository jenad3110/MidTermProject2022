...
public class UnitTestingMath {
    ...
    public static <FindLowestDifference> void main(String[] args) {
        ...
        try {
            Assert.assertEquals(String.valueOf(actualResult), expectedResult, "NOPE TRY AGAIN");
        } catch (Exception ex) {
            ex.getMessage();
        }
        //ASSERT
        ...
        FindLowestDiff FindLowestDifference = null;
